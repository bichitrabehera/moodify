    ...
    <div className="min-h-screen bg-gradient-to-b from-green-900 to-black text-white p-4 sm:p-8 font-sans">
      ...
      <header className="mb-6 sm:mb-8">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-1 sm:mb-2">Moodify</h1>
        </div>
      ...
      <div className="mb-8 sm:mb-12">
        {tracks.length > 0 && (
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Your Mood Playlist</h2>
        )}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {tracks.map((track, index) => (
            <div key={index} className="bg-gray-800 bg-opacity-60 hover:bg-opacity-80 p-3 sm:p-4 rounded-lg transition duration-200 group">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-sm sm:text-base mb-1 truncate text-white">{track.name}</h3>
                  <p className="text-xs text-gray-400 mb-2 sm:mb-3 truncate">by {track.artists}</p>
                  <a 
                    href={track.url} 
                    target="_blank" 
      ...
      <div className="mb-6 sm:mb-8">
        <h2 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-white">How it works</h2>
        <p className="text-xs sm:text-sm text-gray-300 mb-3 sm:mb-4">
          Our algorithm analyzes Spotify's music library to find tracks that match your mood.
        </p>
        <p className="text-xs sm:text-sm text-gray-300">
          Try different moods to discover new music that fits your current state of mind.
        </p>
      </div>
